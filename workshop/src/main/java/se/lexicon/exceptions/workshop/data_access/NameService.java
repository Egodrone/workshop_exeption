...
public class NameService {
     ...
     * @param name
     */
    public void addFemaleFirstName(String name) throws NameException {

        if(femaleFirstNames.contains(name)) {
            throw new NameException(CustomError.NAME_EXIST);
        }
    ...
    public void addMaleFirstName(String name) {
        ...
        if(maleFirstNames.contains(name)) {
            throw new NameException(CustomError.MALE_NAME_EXIST);
        }
    ...
    public void addLastName(String lastName) {
        ...
        if(lastName.contains(lastName)) {
            throw new NameException(CustomError.LAST_NAME_EXIST);
        }
